        ...
        <?php include '../../include/side-bar.php' ?>
                ...
                <div class="button row">
                    ...
                    <div class="row add-posts">
                        ...
                        <div class="row g-3">
                            <div class="col-3">
                                <input value="<?=$title; ?>" name="title" type="text" class="form-control" placeholder="Название товара" aria-label="First name">
                            </div>
                            <div class="col-3">
                                <input value="<?=$article; ?>" name="article"  type="text" class="form-control" placeholder="Артикул товара" aria-label="Last name">
                            </div>
                            <div class="col-3">
                                <input value="<?=$price; ?>" name="price" type="text" class="form-control" placeholder="Цена товара" aria-label="First name">
                            </div>
                            <div class="col-3">
                                <input value="<?=$color; ?>" name="color"  type="text" class="form-control" placeholder="Цвет товара" aria-label="Last name">
                            </div>
                            <div class="col">
                            ...
                            <div class="col-3">
                                ...
                                <textarea name="product__description" class="form-control" id="editor" rows="3"><?=$product__description; ?></textarea>
                            </div>
                            <div class="col-3">
                                <label for="editor" class="form-label">Состав и уход</label>
                                <textarea name="composition__care" class="form-control" id="editor" rows="3"><?=$composition__care; ?></textarea>
                            </div>
                            <div class="w-100"></div>
                            <div class="col-5">
                            ...
                            <div class="col-12">
                                <button name="add_product" class="btn btn-prim" type="submit">Добавить</button>
                            </div>
